      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <div className="inline-flex items-center px-4 py-2 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-white text-sm font-medium mb-6">
            ...
            The Problem Every Supply chain has
          </div>
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white text-balance mb-4 sm:mb-6">
            <span className="text-red-400">60-70%</span> of time is spent on manual repetitive tasks
          </h2>
          {/* <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-3xl mx-auto font-light leading-relaxed">
            Manual repetitive tasks are time-consuming and error-prone with 1 in every 10 tasks being done incorrectly.
          </p> */}
        </div>
          ...
          <div className="group">
            <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6 sm:p-8 h-full hover:bg-white/10 transition-all duration-500 hover:border-red-400/30">
              ...
              <div className="bg-red-500/10 backdrop-blur-sm border border-red-500/20 rounded-xl p-4 sm:p-6 mb-6">
                <div className="text-3xl sm:text-4xl font-bold text-red-400 mb-2"> 50-60% </div>
                <p className="text-white/80 text-sm sm:text-base">
                of time lost to manual tasks that doesn’t move the business forward.
                </p>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  Endless Excel updates and reconciliations
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-red-400 rounded-full mt-2 flex-shrink-0"></div>
                  <p className="text-white/70 text-sm sm:text-base">
                  Manual PO/SO creation, follow-ups, and approvals
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-red-400 rounded-full mt-2 flex-shrink-0"></div>
                  <p className="text-white/70 text-sm sm:text-base">
                  Constant email, calls, and WhatsApp coordination
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-red-400 rounded-full mt-2 flex-shrink-0"></div>
                  <p className="text-white/70 text-sm sm:text-base">Decisions delayed due to outdated or incomplete data</p>
                </div>
              </div>

              {/* Consolidated Statement */}
              <h5 className="text-lg sm:text-xl font-semibold text-white/90 mb-4 mt-6">
              📉 Result: Slow execution, higher errors, burned-out teams, and lost opportunities.
              </h5>
            </div>
          </div>
          ...
          <div className="group">
            <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6 sm:p-8 h-full hover:bg-white/10 transition-all duration-500 hover:border-green-400/30">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-xl sm:text-2xl font-bold text-green-400">Our Solution - Stoqr</h3>
              </div>
              ...
              <div className="bg-green-500/10 backdrop-blur-sm border border-green-500/20 rounded-xl p-4 sm:p-6 mb-6">
                ...
                <p className="text-white/80 text-sm sm:text-base">
                autonomous operations - no delays, no handoffs, no missed actions.
                </p>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  <CheckCircle />
                  <p className="text-white/70 text-sm sm:text-base">Automates repetitive supply chain workflows end-to-end</p>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle />
                  <p className="text-white/70 text-sm sm:text-base">Proactively detects issues and resolves them</p>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle />
                  <p className="text-white/70 text-sm sm:text-base">Orchestrates suppliers, logistics, and internal teams</p>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle />
                  <p className="text-white/70 text-sm sm:text-base">Scales without adding headcount</p>
                </div>
              </div>

              {/* Consolidated Statement */}
              <h5 className="text-lg sm:text-xl font-semibold text-white/90 mb-4 mt-6">
              📈 Result: Faster decisions, lower costs, happier teams, and a supply chain that runs itself.
              </h5>
            </div>
          </div>
        </div>
